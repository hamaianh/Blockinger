...
public class GameOverDialog extends DialogFragment implements View.OnClickListener{
    ...
    private void initView(View v) {
        Utils.setTypefaceGameOver(getDialog().getWindow().getContext(), v.findViewById(R.id.gameover_title_id));
        Utils.setTypefaceGameOver(getDialog().getWindow().getContext(), v.findViewById(R.id.gameover_score_text_id));
        Utils.setTypefaceGameOver(getDialog().getWindow().getContext(), v.findViewById(R.id.gameover_score_point_id));
        Utils.setTypefaceGameOver(getDialog().getWindow().getContext(), v.findViewById(R.id.gameover_apm_text_id));
        Utils.setTypefaceGameOver(getDialog().getWindow().getContext(), v.findViewById(R.id.gameover_apm_point_id));
        Utils.setTypefaceGameOver(getDialog().getWindow().getContext(), v.findViewById(R.id.gameover_time_text_id));
        Utils.setTypefaceGameOver(getDialog().getWindow().getContext(), v.findViewById(R.id.gameover_time_id));
        Utils.setTypefaceGameOver(getDialog().getWindow().getContext(), v.findViewById(R.id.gameover_back_button_id));
